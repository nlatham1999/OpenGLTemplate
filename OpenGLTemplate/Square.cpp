...
void Square::checkShaderCompilation(GLuint* shader)
{
	int  success;
	char infoLog[512];
...
void Square::drawShape(GLFWwindow* window)
{
	float vertices[] = {
	...
	//create and load the vertext shader
	...
	//check to make sure the shader was compiled correctly
